    ...
    <div>
      <div className=" sect-cover grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 mx-2 sm:mx-2 md:mx-2 mt-2 px-4 sm:px-6 md:px-7 lg:px-7 py-5 md:pt-24 lg:pt-32  bg-white">
        <div className="flex justify-start flex-col sm:mr-0 md:mr-2 lg:mr-10 pr-10 lg:ml-20 ml-3 ">
          <div className="border-2 border-solid border-gray-200  font-custom opacity-90 mx-3 rounded-full px-3 sm:px-6 md:px-6 lg:px-10 text-xs">
        ...
        <div className="flex flex-col lg:justify-end mt-6 sm:justify-start sm:mt-10 lg:mt-16 lg:mr-24 mr-1 lg:ml-9 ml-1 shadow-lg shadow-black hover:shadow-indigo-900/40 ">
          <div
